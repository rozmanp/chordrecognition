...
public final class Consts {
    ...
    public static final float WINDOW_SIZE_IN_SEC = 0.4f;
    public static final int BUFFER_SIZE_IN_BYTES = 2 * MIN_BUFFER_SIZE_IN_BYTES;
    public static final int BYTES_PER_ELEMENT = 4;      //PCM-16 encoding
    ...
    //public static final float MIN_FREQ = 61.74f;        //note B1
